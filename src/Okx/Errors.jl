...
# UNDEF
isretriable(::APIsResult{OkxAPIError}) = true

# SUCCESS
isretriable(e::APIsResult{OkxAPIError{0}}) = false

# Operation failed.
isretriable(e::APIsResult{OkxAPIError{1}}) = false

# Bulk operation partially succeeded.
isretriable(e::APIsResult{OkxAPIError{2}}) = false

# Body for POST request cannot be empty.
isretriable(e::APIsResult{OkxAPIError{50000}}) = false

# Service temporarily unavailable. Try again later
isretriable(e::APIsResult{OkxAPIError{50001}}) = true

# JSON syntax error
isretriable(e::APIsResult{OkxAPIError{50002}}) = false

# API endpoint request timeout (does not mean that the request was successful or failed, please check the request result).
isretriable(e::APIsResult{OkxAPIError{50004}}) = true
retry_timeout(e::APIsResult{OkxAPIError{50004}}) = 5

# API is offline or unavailable.
isretriable(e::APIsResult{OkxAPIError{50005}}) = true
retry_timeout(e::APIsResult{OkxAPIError{50005}}) = 5

# Invalid Content-Type. Please use "application/JSON".
isretriable(e::APIsResult{OkxAPIError{50006}}) = false

# Account blocked.
isretriable(e::APIsResult{OkxAPIError{50007}}) = false

# User does not exist.
isretriable(e::APIsResult{OkxAPIError{50008}}) = false

# Account is suspended due to ongoing liquidation.
isretriable(e::APIsResult{OkxAPIError{50009}}) = false

# User ID cannot be empty.
isretriable(e::APIsResult{OkxAPIError{50010}}) = false

# Rate limit reached. Please refer to API documentation and throttle requests accordingly
isretriable(e::APIsResult{OkxAPIError{50011}}) = true
retry_timeout(e::APIsResult{OkxAPIError{50011}}) = 2
retry_maxcount(e::APIsResult{OkxAPIError{50011}}) = 50

# Account status invalid. Check account status
isretriable(e::APIsResult{OkxAPIError{50012}}) = false

# Systems are busy. Please try again later.
isretriable(e::APIsResult{OkxAPIError{50013}}) = true

# Parameter {param0}} cannot be empty.
isretriable(e::APIsResult{OkxAPIError{50014}}) = false

# Either parameter {param0}} or {param1}} is required.
isretriable(e::APIsResult{OkxAPIError{50015}}) = false

# Parameter {param0}} and {param1}} is an invalid pair.
isretriable(e::APIsResult{OkxAPIError{50016}}) = false

# Position frozen and related operations restricted due to auto-deleveraging (ADL). Try again later
isretriable(e::APIsResult{OkxAPIError{50017}}) = false

# {param0}} frozen and related operations restricted due to auto-deleveraging (ADL). Try again later
isretriable(e::APIsResult{OkxAPIError{50018}}) = false

# Account frozen and related operations restricted due to auto-deleveraging (ADL). Try again later
isretriable(e::APIsResult{OkxAPIError{50019}}) = false

# Position frozen and related operations are restricted due to liquidation. Try again later
isretriable(e::APIsResult{OkxAPIError{50020}}) = false

# {param0}} frozen and related operations are restricted due to liquidation. Try again later
isretriable(e::APIsResult{OkxAPIError{50021}}) = false

# Account frozen and related operations are restricted due to liquidation. Try again later
isretriable(e::APIsResult{OkxAPIError{50022}}) = false

# Funding fees frozen and related operations are restricted. Try again later
isretriable(e::APIsResult{OkxAPIError{50023}}) = false

# Either parameter {param0}} or {param1}} should be submitted.
isretriable(e::APIsResult{OkxAPIError{50024}}) = false

# Parameter {param0}} count exceeds the limit {param1}}.
isretriable(e::APIsResult{OkxAPIError{50025}}) = false

# System error. Try again later
isretriable(e::APIsResult{OkxAPIError{50026}}) = true
retry_timeout(e::APIsResult{OkxAPIError{50026}}) = 5

# This account is restricted from trading. Please contact customer support for assistance.
isretriable(e::APIsResult{OkxAPIError{50027}}) = false

# Unable to take the order, please reach out to support center for details.
isretriable(e::APIsResult{OkxAPIError{50028}}) = false
