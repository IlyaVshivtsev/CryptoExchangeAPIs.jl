...
"""
    ...
    klines(client::BinanceClient = Binance.BinanceClient(Binance.public_dapi_config); kw...)
...
result = Binance.DAPI.V1.klines(;
    symbol = "ADAUSD_PERP",
    interval = Binance.DAPI.V1.Klines.TimeInterval.M1,
)
```
"""
function klines(client::BinanceClient, query::KlinesQuery)
    return APIsRequest{Vector{KlinesData}}("GET", "dapi/v1/klines", query)(client)
end
