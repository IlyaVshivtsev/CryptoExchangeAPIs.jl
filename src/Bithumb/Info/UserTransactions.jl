...
function Serde.SerQuery.ser_type(::Type{<:BithumbPrivateQuery}, x::SearchStatus.T)::Int64
    return Int64(x)
end
...
Base.@kwdef mutable struct UserTransactionsQuery <: BithumbPrivateQuery
    ...
    searchGb::Maybe{SearchStatus.T} = nothing
...
result = Bithumb.Info.user_transactions(
    bithumb_client;
    order_currency = "BTC",
